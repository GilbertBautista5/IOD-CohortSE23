...
export default function PostListReducer() {
  ...
  // same thing using useState instead:
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        // same thing using useState instead:
        //setPostsResultState({ loading: false, posts: response.data, error: '' })
      })
      .catch((error) => {
        console.log(error)
        ...
        // same thing using useState instead:
        //setPostsResultState({ loading: false, posts: [], error: error.message })
      });
  }, []);
